                ...
                <Columns>
                    <Columns.Column size={6} className="py-1">
                        <ProjectCard logo={projectSteamAcademy} name="STEAM Academy" url="https://steamacademy.pro">
                            Currently <span className="has-text-weight-bold gray">CTO </span>
                            for an EdTech startup and a self-developed Robot.
                            <span className="has-text-weight-bold gray"> Growing rapidly in Ireland and USA. </span>
                        </ProjectCard>
                    </Columns.Column>
                    <Columns.Column size={6} className="py-1">
                    ...
                    <Columns.Column size={6} className="py-1">
                        <ProjectCard logo={projectABF} name="ABF Informatics" url="">
                            ...
                            <span className="has-text-weight-bold gray"> patient-safety software </span>
